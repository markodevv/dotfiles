function void
tc_setup_mapping(Mapping *mapping, i64 global_id, i64 file_id, i64 code_id){
    MappingScope();
    ...
    Bind(tc_project_command_lister,     KeyCode_X, KeyCode_Alt, KeyCode_Shift);
    Bind(list_all_functions_current_buffer_lister, KeyCode_I, KeyCode_Control, KeyCode_Shift);
    Bind(exit_4coder,          KeyCode_F4, KeyCode_Alt);
    Bind(tc_project_fkey_command, KeyCode_F1);
    Bind(tc_project_fkey_command, KeyCode_F2);
    Bind(tc_project_fkey_command, KeyCode_F3);
    Bind(tc_project_fkey_command, KeyCode_F4);
    Bind(tc_project_fkey_command, KeyCode_F5);
    Bind(tc_project_fkey_command, KeyCode_F6);
    Bind(tc_project_fkey_command, KeyCode_F7);
    Bind(tc_project_fkey_command, KeyCode_F8);
    Bind(tc_project_fkey_command, KeyCode_F9);
    Bind(tc_project_fkey_command, KeyCode_F10);
    Bind(tc_project_fkey_command, KeyCode_F11);
    Bind(tc_project_fkey_command, KeyCode_F12);
    Bind(tc_project_fkey_command, KeyCode_F13);
    Bind(tc_project_fkey_command, KeyCode_F14);
    Bind(tc_project_fkey_command, KeyCode_F15);
    Bind(tc_project_fkey_command, KeyCode_F16);
    ...
    Bind(seek_end_of_line,       KeyCode_E, KeyCode_Control); // @note(tyler): Emacs
    Bind(seek_beginning_of_line, KeyCode_Home);
    Bind(seek_beginning_of_line, KeyCode_A, KeyCode_Control); // @note(tyler): Emacs
    ...
    Bind(replace_in_range,            KeyCode_A, KeyCode_Control, KeyCode_Shift);
    Bind(copy,                        KeyCode_C, KeyCode_Control);
    Bind(delete_range,                KeyCode_D, KeyCode_Control);
    Bind(delete_line,                 KeyCode_D, KeyCode_Control, KeyCode_Shift);
    Bind(center_view,                 KeyCode_E, KeyCode_Alt);
    Bind(left_adjust_view,            KeyCode_E, KeyCode_Alt, KeyCode_Shift);
    ...
    Bind(preview_function_parameters, KeyCode_Return, KeyCode_Control);
    // Bind(auto_indent_range,          KeyCode_Tab, KeyCode_Control);
    // Bind(auto_indent_line_at_cursor, KeyCode_Tab, KeyCode_Shift);
    Bind(word_complete_drop_down,    KeyCode_Tab, KeyCode_Alt);
