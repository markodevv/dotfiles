...
defcolor_function_name = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_function_name"));
defcolor_type_name = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_type_name"));
defcolor_identifier = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_identifier"));
buffer_language = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("buffer_language"));
buffer_code_index_table = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("buffer_code_index_table"));
buffer_errors = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("buffer_errors"));
view_function_index_menu = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("view_function_index_menu"));
}
